    ...
    <>
      ...
      />
        ...
        <div className=" p-4 relative z-10 w-full text-center">
           ...
           <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facere dolorum doloremque officiis ullam? Fugit aperiam architecto voluptate magni amet, asperiores blanditiis ab exercitationem eos saepe tempore officiis quia, corporis dolores!</p>
           <div className=" mt-4">
         <Link href={"/courses"}>
         <div>
      <Button
